...
import { a as tt } from "@nf-internal/chunk-NCEIK542";
...
import { c as st, f as ot, k as nt } from "@nf-internal/chunk-NPG5RFMM";
import { f as L, i as x, q as I } from "@nf-internal/chunk-7DWQP4SD";
import { b as X, d as et } from "@nf-internal/chunk-JHGJD5QO";
import { b as it } from "@nf-internal/chunk-OH3XPIE7";
...
import { DOCUMENT as P, NgZone as S, inject as d, Injector as C, RendererFactory2 as K, afterNextRender as rt, ElementRef as G, ApplicationRef as kt, Renderer2 as St, ANIMATION_MODULE_TYPE as Ct, EnvironmentInjector as xt, InjectionToken as Rt, EventEmitter as b, TemplateRef as Pt, ViewContainerRef as Et, booleanAttribute as w } from "@angular/core";
import { Location as Dt } from "@angular/common";
import { Subject as O, Subscription as k } from "rxjs";
import { filter as Bt, takeWhile as Mt } from "rxjs/operators";
var at = it();
function At(s) { return new V(s.get(x), s.get(P)); }
var V = class {
    _viewportRuler;
...
function Yt(s, t) { return new H(s.get(L), s.get(S), s.get(x), t); }
var H = class {
    _scrollDispatcher;
    _ngZone;
    _viewportRuler;
...
var W = class {
    ...
    constructor() { }
    noop = () => new R;
    close = e => Yt(this._injector, e);
    block = () => At(this._injector);
...
var yt = (() => { class s {
    ...
    static \u0275fac = function (i) { return new (i || s); };
    static \u0275prov = f.\u0275\u0275defineInjectable({ token: s, factory: s.\u0275fac, providedIn: "root" });
} return s; })(), Tt = (() => { class s extends yt {
    _ngZone = d(S);
...
}, _t = "cdk-overlay-connected-position-bounding-box", It = /([A-Za-z%]+)$/;
...
var j = class {
    ...
    _applyPosition(t, e) { if (this._setTransformOrigin(t), this._setOverlayElementStyles(e, t), this._setBoundingBoxStyles(e, t), t.panelClass && this._addPanelClasses(t.panelClass), this._positionChanges.observers.length) {
        ...
        if (t !== this._lastPosition || !this._lastScrollVisibility || !Vt(this._lastScrollVisibility, i)) {
            let o = new N(t, i);
...
function Vt(s, t) { return s === t ? !0 : s.isOriginClipped === t.isOriginClipped && s.isOriginOutsideView === t.isOriginOutsideView && s.isOverlayClipped === t.isOverlayClipped && s.isOverlayOutsideView === t.isOverlayOutsideView; }
...
function wt(s, t) { s.get(A).load(vt); let e = s.get(mt), i = s.get(P), o = s.get(Q), n = s.get(kt), r = s.get(X), a = i.createElement("div"), h = i.createElement("div"); h.id = o.getId("cdk-overlay-"), h.classList.add("cdk-overlay-pane"), a.appendChild(h), e.getContainerElement().appendChild(a); let c = new ot(h, n, s), l = new M(t), _ = s.get(St, null, { optional: !0 }) || s.get(K).createRenderer(null, null); return l.direction = l.direction || r.value, new Z(c, a, h, l, s.get(S), s.get(Tt), i, s.get(Dt), s.get(Lt), t?.disableAnimations ?? s.get(Ct, null, { optional: !0 }) === "NoopAnimations", s.get(xt), _); }
var Wt = (() => { class s {
    scrollStrategies = d(Xt);
    _positionBuilder = d(Ft);
    _injector = d(C);
    constructor() { }
    ...
    static \u0275fac = function (i) { return new (i || s); };
    static \u0275prov = f.\u0275\u0275defineInjectable({ token: s, factory: s.\u0275fac, providedIn: "root" });
} return s; })(), Nt = [{ originX: "start", originY: "bottom", overlayX: "start", overlayY: "top" }, { originX: "start", originY: "top", overlayX: "start", overlayY: "bottom" }, { originX: "end", originY: "top", overlayX: "end", overlayY: "bottom" }, { originX: "end", originY: "bottom", overlayX: "end", overlayY: "top" }], Ot = new Rt("cdk-connected-overlay-scroll-strategy", { providedIn: "root", factory: () => { let s = d(C); return () => q(s); } }), ut = (() => { class s {
    elementRef = d(G);
    constructor() { }
    static \u0275fac = function (i) { return new (i || s); };
    ...
    constructor() { let e = d(Pt), i = d(Et); this._templatePortal = new st(e, i), this.scrollStrategy = this._scrollStrategyFactory(); }
    ...
    attachOverlay() { this._overlayRef ? this._overlayRef.getConfig().hasBackdrop = this.hasBackdrop : this._createOverlay(), this._overlayRef.hasAttached() || this._overlayRef.attach(this._templatePortal), this.hasBackdrop ? this._backdropSubscription = this._overlayRef.backdropClick().subscribe(e => { this.backdropClick.emit(e); }) : this._backdropSubscription.unsubscribe(), this._positionSubscription.unsubscribe(), this.positionChange.observers.length > 0 && (this._positionSubscription = this._position.positionChanges.pipe(Mt(() => this.positionChange.observers.length > 0)).subscribe(e => { this._ngZone.run(() => this.positionChange.emit(e)), this.positionChange.observers.length === 0 && this._positionSubscription.unsubscribe(); })), this.open = !0; }
...
var Zt = { provide: Ot, useFactory: zt }, Se = (() => { class s {
    static \u0275fac = function (i) { return new (i || s); };
    static \u0275mod = f.\u0275\u0275defineNgModule({ type: s });
    static \u0275inj = f.\u0275\u0275defineInjector({ providers: [Wt, Zt], imports: [et, nt, I, I] });
} return s; })();
export { At as a, V as b, Yt as c, H as d, ve as e, R as f, q as g, W as h, Xt as i, M as j, ht as k, ct as l, N as m, me as n, be as o, Tt as p, Lt as q, mt as r, Z as s, bt as t, j as u, we as v, Oe as w, Ht as x, $ as y, Ft as z, wt as A, Wt as B, ut as C, ke as D, Se as E };
