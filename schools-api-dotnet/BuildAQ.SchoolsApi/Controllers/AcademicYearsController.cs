...
namespace BuildAQ.SchoolsApi.Controllers
{
    ...
    public class AcademicYearsController : ControllerBase
    {
        ...
        public AcademicYearsController(BuildAQ.SchoolsApi.Data.SchoolsDbContext context)
        {
            _context = context;
        }
        ...
        {
            var items = await _context.AcademicYears.ToListAsync();
            return Ok(items);
        }
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(int id, AcademicYear item)
        {
