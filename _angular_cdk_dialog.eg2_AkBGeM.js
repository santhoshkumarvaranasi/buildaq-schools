import { B as x, G as N, a as L, j as M, r as B, s as j, x as R } from "@nf-internal/chunk-DWZ2ZU56";
import "@nf-internal/chunk-RECHUXGF";
import { b as v, c as S, e as P, g as Q, h as C, i as D } from "@nf-internal/chunk-NJCF67GI";
import "@nf-internal/chunk-VOHA3QBC";
import "@nf-internal/chunk-FVDLKYOC";
import { h as k, k as T, m as w, u as F } from "@nf-internal/chunk-KBSX3DDG";
...
import { b as y } from "@nf-internal/chunk-6H44B76B";
import "@nf-internal/chunk-JE6VEUSL";
import "@nf-internal/chunk-MQ6KVUBG";
import "@nf-internal/chunk-PY7ZE27C";
...
function Te() { throw Error("Attempting to attach dialog content after content is already attached"); }
var te = (() => {
    class n extends P {
        _elementRef = c(V);
        ...
        _restoreFocus() {
            let e = this._config.restoreFocus, t = null;
            if (typeof e == "string" ? t = this._document.querySelector(e) : typeof e == "boolean" ? t = e ? this._elementFocusedBeforeDialogWasOpened : null : e && (t = e), this._config.restoreFocus && t && typeof t.focus == "function") {
        ...
        static ɵcmp = r.ɵɵdefineComponent({ type: n, selectors: [["cdk-dialog-container"]], viewQuery: function (t, i) {
                if (t & 1 && r.ɵɵviewQuery(C, 7), t & 2) {
                    let o;
...
var ae = (() => {
    class n {
        ...
        constructor() { }
        open(e, t) {
            let i = this._defaultOptions || new h;
            t = u(u({}, i), t), t.id = t.id || this._idGenerator.getId("cdk-dialog-"), t.id && this.getDialogById(t.id);
            let o = this._getOverlayConfig(t), l = x(this._injector, o), s = new f(l, t), d = this._attachContainer(l, s, t);
            if (s.containerInstance = d, !this.openDialogs.length) {
