...
var ce = new S("cdk-input-modality-detector-options"), ae = { ignoreKeys: [18, 17, 224, 91, 16] }, j = 650, A = { passive: !0, capture: !0 }, ue = (() => {
    class o {
        _platform = u(l);
        _listenerCleanups;
        modalityDetected;
        ...
        constructor() {
            let e = u(x), t = u(B), n = u(ce, { optional: !0 });
            if (this._options = g(g({}, ae), n), this.modalityDetected = this._modality.pipe(ie(1)), this.modalityChanged = this.modalityDetected.pipe(se()), this._platform.isBrowser) {
    ...
    return o;
})(), b = function (o) { return o[o.IMMEDIATE = 0] = "IMMEDIATE", o[o.EVENTUAL = 1] = "EVENTUAL", o; }(b || {}), de = new S("cdk-focus-monitor-default-options"), p = k({ passive: !0, capture: !0 }), le = (() => {
    class o {
        _ngZone = u(x);
        _platform = u(l);
        ...
        monitor(e, t = !1) {
            let n = m(e);
            if (!this._platform.isBrowser || n.nodeType !== 1)
                return ne();
            let s = F(n) || this._document, r = this._elementInfo.get(n);
            if (r)
                return t && (r.checkChildren = !0), r.subject;
            let d = { checkChildren: t, subject: new R, rootNode: s };
            return this._elementInfo.set(n, d), this._registerGlobalListeners(d), d.subject;
        }
        ...
        _setOrigin(e, t = !1) {
            this._ngZone.runOutsideAngular(() => {
                if (this._origin = e, this._originFromTouchInteraction = e === "touch" && t, this._detectionMode === b.IMMEDIATE) {
        ...
        _isLastInteractionFromInputLabel(e) {
            let { _mostRecentTarget: t, mostRecentModality: n } = this._inputModalityDetector;
            if (n !== "mouse" || !t || t === e || e.nodeName !== "INPUT" && e.nodeName !== "TEXTAREA" || e.disabled)
                return !1;
            let s = e.labels;
            if (s) {
    ...
    class o {
        ...
        isTabbable(e) {
            if (!this._platform.isBrowser)
                return !1;
            let t = me(Ce(e));
            if (t && (W(t) === -1 || !this.isVisible(t)))
                return !1;
            let n = e.nodeName.toLowerCase(), s = W(e);
            return e.hasAttribute("contenteditable") ? s !== -1 : n === "iframe" || n === "object" || this._platform.WEBKIT && this._platform.IOS && !ve(e) ? !1 : n === "audio" ? e.hasAttribute("controls") ? s !== -1 : !1 : n === "video" ? s === -1 ? !1 : s !== null ? !0 : this._platform.FIREFOX || e.hasAttribute("controls") : e.tabIndex >= 0;
        }
...
function $(o) {
    if (!o.hasAttribute("tabindex") || o.tabIndex === void 0)
        return !1;
...
function W(o) {
    if (!$(o))
        return null;
    let i = parseInt(o.getAttribute("tabindex") || "", 10);
    return isNaN(i) ? -1 : i;
}
...
var y = class {
    ...
    _getFirstTabbableElement(i) {
        if (this._checker.isFocusable(i) && this._checker.isTabbable(i))
            return i;
        let e = i.children;
    ...
    return o;
})(), Fe = new K("liveAnnouncerElement", { providedIn: "root", factory: () => null }), we = new K("LIVE_ANNOUNCER_DEFAULT_OPTIONS"), ke = 0, Le = (() => {
    class o {
        _ngZone = c(C);
        ...
        _createLiveElement() {
            let e = "cdk-live-announcer-element", t = this._document.getElementsByClassName(e), n = this._document.createElement("div");
            for (let s = 0; s < t.length; s++)
                t[s].remove();
            return n.classList.add(e), n.classList.add("cdk-visually-hidden"), n.setAttribute("aria-atomic", "true"), n.setAttribute("aria-live", "polite"), n.id = `cdk-live-announcer-${ke++}`, this._document.body.appendChild(n), n;
        }
        _exposeAnnouncerToModals(e) {
            let t = this._document.querySelectorAll("body > .cdk-overlay-container [aria-modal=\"true\"]");
    ...
    return o;
})(), h = function (o) { return o[o.NONE = 0] = "NONE", o[o.BLACK_ON_WHITE = 1] = "BLACK_ON_WHITE", o[o.WHITE_ON_BLACK = 2] = "WHITE_ON_BLACK", o; }(h || {}), V = "cdk-high-contrast-black-on-white", U = "cdk-high-contrast-white-on-black", v = "cdk-high-contrast-active", Oe = (() => {
    class o {
        _platform = c(l);
        ...
        getHighContrastMode() {
            ...
            let t = this._document.defaultView || window, n = t && t.getComputedStyle ? t.getComputedStyle(e) : null, s = (n && n.backgroundColor || "").replace(/ /g, "");
            switch (e.remove(), s) {
                case "rgb(0,0,0)":
                case "rgb(45,50,54)":
