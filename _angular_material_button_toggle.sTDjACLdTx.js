import { a as y } from "@nf-internal/chunk-XKVFI5WP";
import { a as _ } from "@nf-internal/chunk-G6LXKUAW";
import { d as f } from "@nf-internal/chunk-PGOQVX7J";
import { a as v } from "@nf-internal/chunk-4MZRILT7";
import { c as h } from "@nf-internal/chunk-HOIKB3FD";
import { a as k } from "@nf-internal/chunk-7ZTCWLLR";
import "@nf-internal/chunk-PRCOYL4O";
import { a as c } from "@nf-internal/chunk-2H5YBILG";
...
import { a as p } from "@nf-internal/chunk-7N7HFQKY";
...
import { _IdGenerator as x, FocusMonitor as O } from "@angular/cdk/a11y";
import { Directionality as D } from "@angular/cdk/bidi";
import * as a from "@angular/core";
import { InjectionToken as T, forwardRef as V, inject as r, ChangeDetectorRef as I, EventEmitter as u, booleanAttribute as s, ElementRef as F, HostAttributeToken as L, signal as N } from "@angular/core";
...
var S = new T("MAT_BUTTON_TOGGLE_DEFAULT_OPTIONS", { providedIn: "root", factory: Q });
function Q() { return { hideSingleSelectionIndicator: !1, hideMultipleSelectionIndicator: !1, disabledInteractive: !1 }; }
var M = new T("MatButtonToggleGroup"), j = { provide: P, useExisting: V(() => W), multi: !0 }, d = class {
    source;
    value;
    ...
    _name = r(x).getId("mat-button-toggle-group-");
    vertical;
    ...
    constructor() { let t = r(S, { optional: !0 }); this.appearance = t && t.appearance ? t.appearance : "standard", this.hideSingleSelectionIndicator = t?.hideSingleSelectionIndicator ?? !1, this.hideMultipleSelectionIndicator = t?.hideMultipleSelectionIndicator ?? !1; }
    ngOnInit() { this._selectionModel = new k(this.multiple, void 0, !1); }
    ...
    _keydown(t) { if (this.multiple || this.disabled || m(t))
    ...
    class l {
        ...
        change = new u;
        constructor() { r(p).load(v); let t = r(M, { optional: !0 }), o = r(new L("tabindex"), { optional: !0 }) || "", e = r(S, { optional: !0 }); this._tabIndex = N(parseInt(o) || 0), this.buttonToggleGroup = t, this.appearance = e && e.appearance ? e.appearance : "standard", this.disabledInteractive = e?.disabledInteractive ?? !1; }
...
`], encapsulation: 2, changeDetection: 0 });
    ...
    static \u0275inj = a.\u0275\u0275defineInjector({ imports: [c, _, w, c] });
} return l; })();
export { S as MAT_BUTTON_TOGGLE_DEFAULT_OPTIONS, M as MAT_BUTTON_TOGGLE_GROUP, Q as MAT_BUTTON_TOGGLE_GROUP_DEFAULT_OPTIONS_FACTORY, j as MAT_BUTTON_TOGGLE_GROUP_VALUE_ACCESSOR, w as MatButtonToggle, d as MatButtonToggleChange, W as MatButtonToggleGroup, ht as MatButtonToggleModule };
