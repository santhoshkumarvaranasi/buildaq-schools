import { a as f, b as T, c as p } from "@nf-internal/chunk-FVDLKYOC";
import { b as z, d as w } from "@nf-internal/chunk-6H44B76B";
import { a as _, c as b } from "@nf-internal/chunk-MQ6KVUBG";
import { b as O, c as E, e as S, f as V } from "@nf-internal/chunk-PY7ZE27C";
import { a as g } from "@nf-internal/chunk-7RHXFCZM";
import * as o from "@angular/core";
import { InjectionToken as M, forwardRef as U, inject as s, NgZone as v, RendererFactory2 as L, ElementRef as x, Renderer2 as H, DOCUMENT as I, ChangeDetectorRef as G, signal as C, Injector as Z, effect as $, ApplicationRef as Y, DestroyRef as q, untracked as Q, afterNextRender as X, booleanAttribute as K, ViewContainerRef as J, TemplateRef as ee, IterableDiffers as te } from "@angular/core";
import { Subject as u, of as P, Observable as A, Subscription as ie, animationFrameScheduler as re, asapScheduler as ne, isObservable as oe } from "rxjs";
import { distinctUntilChanged as se, auditTime as k, filter as le, startWith as N, takeUntil as R, pairwise as ae, switchMap as ce, shareReplay as de } from "rxjs/operators";
import "@angular/common";
var he = ["contentWrapper"], ue = ["*"], W = new M("VIRTUAL_SCROLL_STRATEGY"), y = class {
    _scrolledIndexChange = new u;
    scrolledIndexChange = this._scrolledIndexChange.pipe(se());
    _viewport = null;
    _itemSize;
    _minBufferPx;
    _maxBufferPx;
    ...
    _updateRenderedRange() {
        if (!this._viewport)
            return;
        let c = this._viewport.getRenderedRange(), e = { start: c.start, end: c.end }, t = this._viewport.getViewportSize(), i = this._viewport.getDataLength(), n = this._viewport.measureScrollOffset(), l = this._itemSize > 0 ? n / this._itemSize : 0;
        if (e.end > i) {
        ...
        let h = n - e.start * this._itemSize;
        if (h < this._minBufferPx && e.start != 0) {
...
function fe(r) { return r._scrollStrategy; }
var je = (() => {
    class r {
    ...
    class r {
        _ngZone = s(v);
        _platform = s(g);
        _renderer = s(L).createRenderer(null, null);
        ...
        ancestorScrolled(e, t) { let i = this.getAncestorScrollContainers(e); return this.scrolled(t).pipe(le(n => !n || i.indexOf(n) > -1)); }
        ...
        _scrollableContainsElement(e, t) {
            let i = b(t), n = e.getElementRef().nativeElement;
            do
                if (i == n)
                    return !0;
    ...
    class r {
        ...
        measureScrollOffset(e) {
            let t = "left", i = "right", n = this.elementRef.nativeElement;
            if (e == "top")
                return n.scrollTop;
            if (e == "bottom")
                return n.scrollHeight - n.clientHeight - n.scrollTop;
            let l = this.dir && this.dir.value == "rtl";
            return e == "start" ? e = l ? i : t : e == "end" && (e = l ? t : i), l && p() == f.INVERTED ? e == t ? n.scrollWidth - n.clientWidth - n.scrollLeft : n.scrollLeft : l && p() == f.NEGATED ? e == t ? n.scrollLeft + n.scrollWidth - n.clientWidth : -n.scrollLeft : e == t ? n.scrollLeft : n.scrollWidth - n.clientWidth - n.scrollLeft;
        }
        static ɵfac = function (t) { return new (t || r); };
    ...
    class r {
        ...
        _document = s(I);
        constructor() {
            let e = s(v), t = s(L).createRenderer(null, null);
            e.runOutsideAngular(() => {
        ...
        getViewportScrollPosition() {
            if (!this._platform.isBrowser)
                return { top: 0, left: 0 };
            let e = this._document, t = this._getWindow(), i = e.documentElement, n = i.getBoundingClientRect(), l = -n.top || e.body.scrollTop || t.scrollY || i.scrollTop || 0, h = -n.left || e.body.scrollLeft || t.scrollX || i.scrollLeft || 0;
            return { top: l, left: h };
        }
...
var we = typeof requestAnimationFrame < "u" ? re : ne, Se = (() => {
    class r extends D {
        ...
        _viewportChanges = ie.EMPTY;
        _injector = s(Z);
        _isDestroyed = !1;
        constructor() { super(); let e = s(me); this._scrollStrategy, this._viewportChanges = e.change().subscribe(() => { this.checkViewportSize(); }), this.scrollable || (this.elementRef.nativeElement.classList.add("cdk-virtual-scrollable"), this.scrollable = this); let t = $(() => { this._changeDetectionNeeded() && this._doChangeDetection(); }, { injector: s(Y).injector }); s(q).onDestroy(() => void t.destroy()); }
        ngOnInit() { this._platform.isBrowser && (this.scrollable === this && super.ngOnInit(), this.ngZone.runOutsideAngular(() => Promise.resolve().then(() => { this._measureViewportSize(), this._scrollStrategy.attach(this), this.scrollable.elementScrolled().pipe(N(null), k(0, we), R(this._destroyed)).subscribe(() => this._scrollStrategy.onContentScrolled()), this._markChangeDetectionNeeded(); }))); }
        ...
        _doChangeDetection() {
            this._isDestroyed || this.ngZone.run(() => {
                this._changeDetectorRef.markForCheck(), this._contentWrapper.nativeElement.style.transform = this._renderedContentTransform, X(() => {
                    this._changeDetectionNeeded.set(!1);
                    let e = this._runAfterChangeDetection;
        ...
        static ɵfac = function (t) { return new (t || r); };
        static ɵcmp = o.ɵɵdefineComponent({ type: r, selectors: [["cdk-virtual-scroll-viewport"]], viewQuery: function (t, i) {
                if (t & 1 && o.ɵɵviewQuery(he, 7), t & 2) {
                    let n;
...
function F(r, c, e) {
    ...
    return r === "horizontal" ? c === "start" ? i.left : i.right : c === "start" ? i.top : i.bottom;
}
var Ue = (() => {
    class r {
        _viewContainerRef = s(J);
        _template = s(ee);
        _differs = s(te);
        _viewRepeater = s(S);
        _viewport = s(Se, { skipSelf: !0 });
        viewChange = new u;
        _dataSourceChanges = new u;
        get cdkVirtualForOf() { return this._cdkVirtualForOf; }
        set cdkVirtualForOf(e) { this._cdkVirtualForOf = e, O(e) ? this._dataSourceChanges.next(e) : this._dataSourceChanges.next(new E(oe(e) ? e : Array.from(e || []))); }
        _cdkVirtualForOf;
        ...
        dataStream = this._dataSourceChanges.pipe(N(null), ae(), ce(([e, t]) => this._changeDataSource(e, t)), de(1));
        _differ = null;
        _data;
        _renderedItems;
        _renderedRange;
        ...
        measureRangeSize(e, t) {
            if (e.start >= e.end)
                return 0;
            e.start < this._renderedRange.start || e.end > this._renderedRange.end;
            let i = e.start - this._renderedRange.start, n = e.end - e.start, l, h;
            for (let a = 0; a < n; a++) {
        ...
        _updateContext() {
            let e = this._data.length, t = this._viewContainerRef.length;
            for (; t--;) {
        ...
        _applyChanges(e) {
            this._viewRepeater.applyChanges(e, this._viewContainerRef, (n, l, h) => this._getEmbeddedViewArgs(n, h), n => n.item), e.forEachIdentityChange(n => { let l = this._viewContainerRef.get(n.currentIndex); l.context.$implicit = n.item; });
            let t = this._data.length, i = this._viewContainerRef.length;
            for (; i--;) {
