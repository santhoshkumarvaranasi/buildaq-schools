...
function Bi(c, s) { if (c & 1 && t.\u0275\u0275conditionalCreate(0, Ri, 1, 0)(1, Ti, 1, 0, "span", 7), c & 2) {
...
`, b = new m("mat-chips-default-options", { providedIn: "root", factory: () => ({ separatorKeyCodes: [p] }) }), E = new m("MatChipAvatar"), S = new m("MatChipTrailingIcon"), D = new m("MatChipEdit"), M = new m("MatChipRemove"), C = new m("MatChip"), L = (() => { class c {
    _elementRef = r(_);
    _parentChip = r(C);
    _isPrimary = !0;
    _isLeading = !1;
    ...
    class c {
        ...
        static \u0275fac = function (a) { return new (a || c); };
        static \u0275cmp = t.\u0275\u0275defineComponent({ type: c, selectors: [["mat-basic-chip"], ["", "mat-basic-chip", ""], ["mat-chip"], ["", "mat-chip", ""]], contentQueries: function (a, e, o) { if (a & 1 && (t.\u0275\u0275contentQuery(o, E, 5), t.\u0275\u0275contentQuery(o, D, 5), t.\u0275\u0275contentQuery(o, S, 5), t.\u0275\u0275contentQuery(o, M, 5), t.\u0275\u0275contentQuery(o, E, 5), t.\u0275\u0275contentQuery(o, S, 5), t.\u0275\u0275contentQuery(o, D, 5), t.\u0275\u0275contentQuery(o, M, 5)), a & 2) {
                let n;
            ...
            } }, viewQuery: function (a, e) { if (a & 1 && t.\u0275\u0275viewQuery(v, 5), a & 2) {
                let o;
...
`], encapsulation: 2, changeDetection: 0 });
    ...
    static \u0275fac = function (a) { return new (a || c); };
    static \u0275cmp = t.\u0275\u0275defineComponent({ type: c, selectors: [["mat-chip-row"], ["", "mat-chip-row", ""], ["mat-basic-chip-row"], ["", "mat-basic-chip-row", ""]], contentQueries: function (a, e, o) { if (a & 1 && t.\u0275\u0275contentQuery(o, I, 5), a & 2) {
            let n;
            t.\u0275\u0275queryRefresh(n = t.\u0275\u0275loadQuery()) && (e.contentEditInput = n.first);
        } }, viewQuery: function (a, e) { if (a & 1 && t.\u0275\u0275viewQuery(I, 5), a & 2) {
            let o;
    ...
    class c {
        ...
        static \u0275fac = function (a) { return new (a || c); };
        static \u0275cmp = t.\u0275\u0275defineComponent({ type: c, selectors: [["mat-chip-set"]], contentQueries: function (a, e, o) { if (a & 1 && t.\u0275\u0275contentQuery(o, u, 5), a & 2) {
                let n;
...
`], encapsulation: 2, changeDetection: 0 });
...
}, zi = { provide: fi, useExisting: ui(() => Vi), multi: !0 }, Vi = (() => { class c extends ai {
    _onTouched = () => { };
    _onChange = () => { };
    ...
    static \u0275fac = (() => { let i; return function (e) { return (i || (i = t.\u0275\u0275getInheritedFactory(c)))(e || c); }; })();
    static \u0275cmp = t.\u0275\u0275defineComponent({ type: c, selectors: [["mat-chip-listbox"]], contentQueries: function (a, e, o) { if (a & 1 && t.\u0275\u0275contentQuery(o, Oi, 5), a & 2) {
            let n;
            t.\u0275\u0275queryRefresh(n = t.\u0275\u0275loadQuery()) && (e._chips = n);
    ...
    get describedByIds() { if (this._chipInput)
        return this._chipInput.describedByIds || []; let i = this._elementRef.nativeElement.getAttribute("aria-describedby"); return i ? i.split(" ") : []; }
    ...
    _handleKeydown(i) { let a = i.keyCode, e = this._keyManager.activeItem; if (a === U)
    ...
    static \u0275fac = function (a) { return new (a || c); };
    static \u0275cmp = t.\u0275\u0275defineComponent({ type: c, selectors: [["mat-chip-grid"]], contentQueries: function (a, e, o) { if (a & 1 && t.\u0275\u0275contentQuery(o, Hi, 5), a & 2) {
            let n;
            t.\u0275\u0275queryRefresh(n = t.\u0275\u0275loadQuery()) && (e._chips = n);
    ...
    _isSeparatorKey(i) { if (!this.separatorKeyCodes)
        return !1; for (let a of this.separatorKeyCodes) {
        let e, o;
