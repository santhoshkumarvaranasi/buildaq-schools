...
var F = (() => {
    class e {
        ...
        _registerQuery(t) {
            ...
            let r = this._mediaMatcher.matchMedia(t), o = { observable: new j(s => { let n = d => this._zone.run(() => s.next(d)); return r.addListener(n), () => { r.removeListener(n); }; }).pipe(L(r), l(({ matches: s }) => ({ query: t, matches: s })), O(this._destroySubject)), mql: r };
