import { a as V } from "@nf-internal/chunk-BMPGQYLV";
import { i as W, q as $ } from "@nf-internal/chunk-VOHA3QBC";
import "@nf-internal/chunk-FVDLKYOC";
import { b as Q } from "@nf-internal/chunk-6H44B76B";
import "@nf-internal/chunk-MQ6KVUBG";
import { a as J, b as T, d as j, e as O, f as U } from "@nf-internal/chunk-PY7ZE27C";
import { a as B } from "@nf-internal/chunk-7RHXFCZM";
...
function ne(o, r) {
    if (o & 1 && (s.ɵɵelementStart(0, "th", 3), s.ɵɵtext(1), s.ɵɵelementEnd()), o & 2) {
        let e = s.ɵɵnextContext();
        s.ɵɵstyleProp("text-align", e.justify), s.ɵɵadvance(), s.ɵɵtextInterpolate1(" ", e.headerText, " ");
    }
}
function re(o, r) {
    if (o & 1 && (s.ɵɵelementStart(0, "td", 4), s.ɵɵtext(1), s.ɵɵelementEnd()), o & 2) {
...
var w = new A("CDK_TABLE"), me = new A("text-column-options"), N = (() => {
    class o {
        template = l(p);
        constructor() { }
    ...
    class o {
        ...
        static ɵfac = function (t) { return new (t || o); };
        static ɵdir = s.ɵɵdefineDirective({ type: o, selectors: [["", "cdkColumnDef", ""]], contentQueries: function (t, i, n) {
                if (t & 1 && (s.ɵɵcontentQuery(n, N, 5), s.ɵɵcontentQuery(n, F, 5), s.ɵɵcontentQuery(n, ye, 5)), t & 2) {
                    let a;
    ...
    return o;
})(), Ke = "<ng-container cdkCellOutlet></ng-container>", H = (() => {
    class o {
        template = l(p);
        _differs = l(v);
        columns;
    ...
    return o;
})(), K = ["top", "bottom", "left", "right"], I = class {
    _isNativeHtmlTable;
    _stickCellCss;
    _isBrowser;
    ...
    clearStickyPositioning(r, e) {
        (e.includes("left") || e.includes("right")) && this._removeFromStickyColumnReplayQueue(r);
        let t = [];
        for (let i of r)
            i.nodeType === i.ELEMENT_NODE && t.push(i, ...Array.from(i.children));
        E({ write: () => {
                for (let i of t)
                    this._removeStickyStyle(i, e);
            } }, { injector: this._tableInjector });
    }
    updateStickyColumns(r, e, t, i = !0, n = !0) {
        if (!r.length || !this._isBrowser || !(e.some(_ => _) || t.some(_ => _))) {
            this._positionListener?.stickyColumnsUpdated({ sizes: [] }), this._positionListener?.stickyEndColumnsUpdated({ sizes: [] });
            return;
        }
        let a = r[0], c = a.children.length, d = this.direction === "rtl", u = d ? "right" : "left", h = d ? "left" : "right", m = e.lastIndexOf(!0), y = t.indexOf(!0), C, P, L;
        n && this._updateStickyColumnReplayQueue({ rows: [...r], stickyStartStates: [...e], stickyEndStates: [...t] }), E({ earlyRead: () => { C = this._getCellWidths(a, i), P = this._getStickyStartColumnPositions(C, e), L = this._getStickyEndColumnPositions(C, t); }, write: () => {
                for (let _ of r)
                    for (let f = 0; f < c; f++) {
                        let z = _.children[f];
                        e[f] && this._addStickyStyle(z, u, P[f], f === m), t[f] && this._addStickyStyle(z, h, L[f], f === y);
                    }
                this._positionListener && C.some(_ => !!_) && (this._positionListener.stickyColumnsUpdated({ sizes: m === -1 ? [] : C.slice(0, m + 1).map((_, f) => e[f] ? _ : null) }), this._positionListener.stickyEndColumnsUpdated({ sizes: y === -1 ? [] : C.slice(y).map((_, f) => t[f + y] ? _ : null).reverse() }));
            } }, { injector: this._tableInjector });
    }
    stickRows(r, e, t) {
        if (!this._isBrowser)
            return;
        let i = t === "bottom" ? r.slice().reverse() : r, n = t === "bottom" ? e.slice().reverse() : e, a = [], c = [], d = [];
        E({ earlyRead: () => {
                ...
                t === "top" ? this._positionListener?.stickyHeaderRowsUpdated({ sizes: c, offsets: a, elements: d }) : this._positionListener?.stickyFooterRowsUpdated({ sizes: c, offsets: a, elements: d });
            } }, { injector: this._tableInjector });
    }
    ...
    _removeStickyStyle(r, e) {
        if (!r.classList.contains(this._stickCellCss))
            return;
        for (let i of e)
            r.style[i] = "", r.classList.remove(this._borderCellCss[i]);
        K.some(i => e.indexOf(i) === -1 && r.style[i]) ? r.style.zIndex = this._getCalculatedZIndex(r) : (r.style.zIndex = "", this._needsPositionStickyOnElement && (r.style.position = ""), r.classList.remove(this._stickCellCss));
    }
    ...
    _getCalculatedZIndex(r) {
        let e = { top: 100, bottom: 10, left: 1, right: 1 }, t = 0;
        for (let i of K)
            r.style[i] && (t += e[i]);
        return t ? `${t}` : "";
    }
    _getCellWidths(r, e = !0) {
    ...
    _getStickyStartColumnPositions(r, e) {
        let t = [], i = 0;
        for (let n = 0; n < r.length; n++)
            e[n] && (t[n] = i, i += r[n]);
        return t;
    }
    _getStickyEndColumnPositions(r, e) {
        let t = [], i = 0;
        for (let n = r.length; n > 0; n--)
            e[n] && (t[n] = i, i += r[n]);
        return t;
    }
    _retrieveElementSize(r) {
        let e = this._elemSizeCache.get(r);
        if (e)
            return e;
        let t = r.getBoundingClientRect(), i = { width: t.width, height: t.height };
        return this._resizeObserver && (this._elemSizeCache.set(r, i), this._resizeObserver.observe(r, { box: "border-box" })), i;
    }
    ...
    _removeFromStickyColumnReplayQueue(r) {
        let e = new Set(r);
        for (let t of this._updatedStickyColumnsParamsToReplay)
            t.rows = t.rows.filter(i => !e.has(i));
        this._updatedStickyColumnsParamsToReplay = this._updatedStickyColumnsParamsToReplay.filter(t => !!t.rows.length);
    }
    _updateCachedSizes(r) {
        let e = !1;
        for (let t of r) {
        ...
        e && this._updatedStickyColumnsParamsToReplay.length && (this._stickyColumnsReplayTimeout && clearTimeout(this._stickyColumnsReplayTimeout), this._stickyColumnsReplayTimeout = setTimeout(() => {
            if (!this._destroyed) {
                for (let t of this._updatedStickyColumnsParamsToReplay)
...
var X = new A("CDK_SPL"), Ge = (() => {
    ...
    class o {
        ...
        renderRows() {
            ...
            this._viewRepeater.applyChanges(e, t, (i, n, a) => this._getEmbeddedViewArgs(i.item, a), i => i.item.data, i => { i.operation === j.INSERTED && i.context && this._renderCellTemplateForItem(i.record.item.rowDef, i.context); }), this._updateRowIndexContext(), e.forEachIdentityChange(i => { let n = t.get(i.currentIndex); n.context.$implicit = i.item.data; }), this._updateNoDataRow(), this.contentChanged.next(), this.updateStickyColumnStyles();
        }
        ...
        updateStickyHeaderRowStyles() {
            ...
            let t = this._headerRowDefs.map(i => i.sticky);
            this._stickyStyler.clearStickyPositioning(e, ["top"]), this._stickyStyler.stickRows(e, t, "top"), this._headerRowDefs.forEach(i => i.resetStickyChanged());
        }
        updateStickyFooterRowStyles() {
            ...
            let t = this._footerRowDefs.map(i => i.sticky);
            this._stickyStyler.clearStickyPositioning(e, ["bottom"]), this._stickyStyler.stickRows(e, t, "bottom"), this._stickyStyler.updateStickyFooterContainer(this._elementRef.nativeElement, t), this._footerRowDefs.forEach(i => i.resetStickyChanged());
        }
        updateStickyColumnStyles() {
            let e = this._getRenderedRows(this._headerRowOutlet), t = this._getRenderedRows(this._rowOutlet), i = this._getRenderedRows(this._footerRowOutlet);
            (this._isNativeHtmlTable && !this._fixedLayout || this._stickyColumnStylesNeedReset) && (this._stickyStyler.clearStickyPositioning([...e, ...t, ...i], ["left", "right"]), this._stickyColumnStylesNeedReset = !1), e.forEach((n, a) => { this._addStickyColumnStyles([n], this._headerRowDefs[a]); }), this._rowDefs.forEach(n => {
                let a = [];
                for (let c = 0; c < t.length; c++)
                    this._renderRows[c].rowDef === n && a.push(t[c]);
                this._addStickyColumnStyles(a, n);
            }), i.forEach((n, a) => { this._addStickyColumnStyles([n], this._footerRowDefs[a]); }), Array.from(this._columnDefsByName.values()).forEach(n => n.resetStickyChanged());
        }
        ...
        _getAllRenderRows() {
            let e = [], t = this._cachedRenderRowsMap;
            if (this._cachedRenderRowsMap = new Map, !this._data)
                return e;
        ...
        _getRenderRowsForData(e, t, i) {
            return this._getRowDefs(e, t).map(a => {
                let c = i && i.has(a) ? i.get(a) : [];
                if (c.length) {
                    let d = c.shift();
        ...
        _observeRenderChanges() {
            if (!this.dataSource)
                return;
            let e;
            T(this.dataSource) ? e = this.dataSource.connect(this) : _e(this.dataSource) ? e = this.dataSource : Array.isArray(this.dataSource) && (e = q(this.dataSource)), this._renderChangeSubscription = e.pipe(x(this._onDestroy)).subscribe(t => { this._data = t || [], this.renderRows(); });
        }
        ...
        _renderCellTemplateForItem(e, t) {
            for (let i of this._getCellTemplates(e))
                S.mostRecentCellOutlet && S.mostRecentCellOutlet._viewContainer.createEmbeddedView(i, t);
        ...
        _updateNoDataRow() {
            ...
            if (!e)
                return;
            let t = this._rowOutlet.viewContainer.length === 0;
            if (t === this._isShowingNoDataRow)
                return;
            let i = this._noDataRowOutlet.viewContainer;
            if (t) {
                ...
                i.clear();
            this._isShowingNoDataRow = t, this._changeDetectorRef.markForCheck();
        }
        static ɵfac = function (t) { return new (t || o); };
        static ɵcmp = s.ɵɵdefineComponent({ type: o, selectors: [["cdk-table"], ["table", "cdk-table", ""]], contentQueries: function (t, i, n) {
                if (t & 1 && (s.ɵɵcontentQuery(n, Re, 5), s.ɵɵcontentQuery(n, g, 5), s.ɵɵcontentQuery(n, pe, 5), s.ɵɵcontentQuery(n, Z, 5), s.ɵɵcontentQuery(n, G, 5)), t & 2) {
                    let a;
...
function Y(o, r) {
    let e = r.toUpperCase(), t = o.viewContainer.element.nativeElement;
    for (; t;) {
...
var Je = (() => {
    class o {
        ...
        static ɵfac = function (t) { return new (t || o); };
        static ɵcmp = s.ɵɵdefineComponent({ type: o, selectors: [["cdk-text-column"]], viewQuery: function (t, i) {
                if (t & 1 && (s.ɵɵviewQuery(g, 7), s.ɵɵviewQuery(N, 7), s.ɵɵviewQuery(F, 7)), t & 2) {
                    let n;
