...
import { InjectionToken as b, inject as f, DOCUMENT as H, ElementRef as k, ErrorHandler as W, HostAttributeToken as $, booleanAttribute as j } from "@angular/core";
import { Subscription as B } from "rxjs";
import { take as V } from "rxjs/operators";
...
import { tap as S, map as p, catchError as U, finalize as P, share as D } from "rxjs/operators";
...
var c = class {
    ...
    _fetchIcon(t) { let { url: e, options: n } = t, o = n?.withCredentials ?? !1; if (!this._httpClient)
        ...
        return s; let u = this._httpClient.get(r, { responseType: "text", withCredentials: o }).pipe(p(m => g(m)), P(() => this._inProgressUrlFetches.delete(r)), D()); return this._inProgressUrlFetches.set(r, u), u; }
    ...
    _getIconConfigFromResolvers(t, e) { for (let n = 0; n < this._resolvers.length; n++) {
        ...
        if (o)
            return z(o) ? new c(o.url, null, o.options) : new c(o, null);
    } }
...
function z(i) { return !!(i.url && i.options); }
import "@angular/cdk/private";
import "@angular/common/http";
import "@angular/platform-browser";
var q = ["*"], Y = new b("MAT_ICON_DEFAULT_OPTIONS"), J = new b("mat-icon-location", { providedIn: "root", factory: () => { let i = f(H), h = i ? i.location : null; return { getPathname: () => h ? h.pathname + h.search : "" }; } }), A = ["clip-path", "color-profile", "src", "cursor", "fill", "filter", "marker", "marker-start", "marker-mid", "marker-end", "mask", "stroke"], K = A.map(i => `[${i}]`).join(", "), G = /^url\(['"]?#(.*?)['"]?\)$/, vt = (() => {
    class i {
        _elementRef = f(k);
        _iconRegistry = f(R);
        _location = f(J);
        ...
        _currentIconFetch = B.EMPTY;
        constructor() { let t = f(new $("aria-hidden"), { optional: !0 }), e = f(Y, { optional: !0 }); e && (e.color && (this.color = this._defaultColor = e.color), e.fontSet && (this.fontSet = e.fontSet)), t || this._elementRef.nativeElement.setAttribute("aria-hidden", "true"); }
...
`], encapsulation: 2, changeDetection: 0 });
    ...
    static \u0275inj = a.\u0275\u0275defineInjector({ imports: [O] });
} return i; })();
