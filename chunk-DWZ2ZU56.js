...
import { c as it, f as st, i as ot } from "@nf-internal/chunk-NJCF67GI";
import { f as I, i as S, q as T } from "@nf-internal/chunk-VOHA3QBC";
import { b as nt } from "@nf-internal/chunk-FVDLKYOC";
import { a as Q } from "@nf-internal/chunk-RMOXI6XO";
import { d as D } from "@nf-internal/chunk-ZGWTKG5Z";
import { a as Y } from "@nf-internal/chunk-ZVGPI6ZI";
import { b as V, d as et } from "@nf-internal/chunk-6H44B76B";
import { a as f } from "@nf-internal/chunk-JE6VEUSL";
import { k as Ct, lb as tt } from "@nf-internal/chunk-VJYBASWG";
import { a as M } from "@nf-internal/chunk-7RHXFCZM";
import { a as X } from "@nf-internal/chunk-XID2BBVI";
import { a as E, b as J } from "@nf-internal/chunk-4CLCTAJ7";
import * as _ from "@angular/core";
import { DOCUMENT as x, NgZone as C, inject as p, Injector as R, RendererFactory2 as G, afterNextRender as rt, ElementRef as B, InjectionToken as U, ApplicationRef as St, Renderer2 as Pt, ANIMATION_MODULE_TYPE as xt, EnvironmentInjector as Rt, EventEmitter as w, TemplateRef as Et, ViewContainerRef as Dt, booleanAttribute as m } from "@angular/core";
import { Location as Mt } from "@angular/common";
import { Subject as k, Subscription as O } from "rxjs";
import { filter as Bt, takeWhile as At } from "rxjs/operators";
var at = nt();
function Yt(s) { return new W(s.get(S), s.get(x)); }
var W = class {
    _viewportRuler;
    ...
    _canBeEnabled() {
        if (this._document.documentElement.classList.contains("cdk-global-scrollblock") || this._isEnabled)
            return !1;
        let e = this._document.documentElement, i = this._viewportRuler.getViewportSize();
        return e.scrollHeight > i.height || e.scrollWidth > i.width;
    }
};
function Xt(s, t) { return new H(s.get(I), s.get(C), s.get(S), t); }
var H = class {
    _scrollDispatcher;
    _ngZone;
    _viewportRuler;
    ...
    enable() {
        if (this._scrollSubscription)
            return;
        let t = this._scrollDispatcher.scrolled(0).pipe(Bt(e => !e || !this._overlayRef.overlayElement.contains(e.getElementRef().nativeElement)));
        this._config && this._config.threshold && this._config.threshold > 1 ? (this._initialScrollPosition = this._viewportRuler.getViewportScrollPosition().top, this._scrollSubscription = t.subscribe(() => { let e = this._viewportRuler.getViewportScrollPosition().top; Math.abs(e - this._initialScrollPosition) > this._config.threshold ? this._detach() : this._overlayRef.updatePosition(); })) : this._scrollSubscription = t.subscribe(this._detach);
    }
...
function yt(s, t) { return new N(s.get(I), s.get(S), s.get(C), t); }
var N = class {
    _scrollDispatcher;
    _viewportRuler;
    _ngZone;
...
var vt = (() => {
    ...
    class s extends vt {
        ...
        _clickListener = e => {
            let i = D(e), o = e.type === "click" && this._pointerDownEventTarget ? this._pointerDownEventTarget : i;
...
`], encapsulation: 2, changeDetection: 0 });
    ...
    class s {
        ...
        _createContainer() {
            ...
            i.classList.add(e), L() ? i.setAttribute("platform", "test") : this._platform.isBrowser || i.setAttribute("platform", "server"), this._document.body.appendChild(i), this._containerElement = i;
        }
    ...
    _updateElementSize() {
        ...
        t.width = f(this._config.width), t.height = f(this._config.height), t.minWidth = f(this._config.minWidth), t.minHeight = f(this._config.minHeight), t.maxWidth = f(this._config.maxWidth), t.maxHeight = f(this._config.maxHeight);
    }
    ...
    _attachHost() {
        if (!this._host.parentElement) {
            ...
            t ? t instanceof Element ? t.after(this._host) : t.type === "parent" && t.element?.appendChild(this._host) : this._previousHostParent?.appendChild(this._host);
        }
...
}, pt = "cdk-overlay-connected-position-bounding-box", Tt = /([A-Za-z%]+)$/;
function wt(s, t) { return new $(t, s.get(S), s.get(x), s.get(M), s.get(bt)); }
var $ = class {
    _viewportRuler;
    _document;
    _platform;
    ...
    apply() {
        ...
        let t = this._originRect, e = this._overlayRect, i = this._viewportRect, o = this._containerRect, n = [], r;
    ...
    dispose() { this._isDisposed || (this._boundingBox && b(this._boundingBox.style, { top: "", left: "", right: "", bottom: "", height: "", width: "", alignItems: "", justifyContent: "" }), this._pane && this._resetOverlayElementStyles(), this._overlayRef && this._overlayRef.hostElement.classList.remove(pt), this.detach(), this._positionChanges.complete(), this._overlayRef = this._boundingBox = null, this._isDisposed = !0); }
    reapplyLastPosition() {
        if (this._isDisposed || !this._platform.isBrowser)
            return;
    ...
    getPopoverInsertionPoint() {
        if (this._popoverLocation === "global")
            return null;
        let t = null;
        return this._popoverLocation === "inline" ? this._origin instanceof B ? t = this._origin.nativeElement : this._origin instanceof Element && (t = this._origin) : t = this._popoverLocation.element, this._popoverLocation === "inline" ? t : t ? { type: "parent", element: t } : null;
    }
    _getOriginPoint(t, e, i) {
        ...
        e.left < 0 && (o -= e.left);
        let n;
        return i.originY == "center" ? n = t.top + t.height / 2 : n = i.originY == "top" ? t.top : t.bottom, e.top < 0 && (n -= e.top), { x: o, y: n };
    }
    ...
    _getOverlayFit(t, e, i, o) { let n = ft(e), { x: r, y: a } = t, h = this._getOffset(o, "x"), d = this._getOffset(o, "y"); h && (r += h), d && (a += d); let l = 0 - r, c = r + n.width - i.width, g = 0 - a, y = a + n.height - i.height, u = this._subtractOverflows(n.width, l, c), v = this._subtractOverflows(n.height, g, y), q = u * v; return { visibleArea: q, isCompletelyWithinViewport: n.width * n.height === q, fitsInViewportVertically: v === n.height, fitsInViewportHorizontally: u == n.width }; }
    _canFitWithFlexibleDimensions(t, e, i) {
        if (this._hasFlexibleDimensions) {
            let o = i.bottom - e.y, n = i.right - e.x, r = _t(this._overlayRef.getConfig().minHeight), a = _t(this._overlayRef.getConfig().minWidth), h = t.fitsInViewportVertically || r != null && r <= o, d = t.fitsInViewportHorizontally || a != null && a <= n;
            return h && d;
        }
        return !1;
    }
    _pushOverlayOnScreen(t, e, i) {
        ...
        let o = ft(e), n = this._viewportRect, r = Math.max(t.x + o.width - n.width, 0), a = Math.max(t.y + o.height - n.height, 0), h = Math.max(n.top - i.top - t.y, 0), d = Math.max(n.left - i.left - t.x, 0), l = 0, c = 0;
        return o.width <= n.width ? l = d || -r : l = t.x < this._getViewportMarginStart() ? n.left - i.left - t.x : 0, o.height <= n.height ? c = h || -a : c = t.y < this._getViewportMarginTop() ? n.top - i.top - t.y : 0, this._previousPushAmount = { x: l, y: c }, { x: t.x + l, y: t.y + c };
    }
    _applyPosition(t, e) {
        if (this._setTransformOrigin(t), this._setOverlayElementStyles(e, t), this._setBoundingBoxStyles(e, t), t.panelClass && this._addPanelClasses(t.panelClass), this._positionChanges.observers.length) {
            ...
            if (t !== this._lastPosition || !this._lastScrollVisibility || !Wt(this._lastScrollVisibility, i)) {
                let o = new z(t, i);
    ...
    _setTransformOrigin(t) {
        if (!this._transformOriginSelector)
            return;
        let e = this._boundingBox.querySelectorAll(this._transformOriginSelector), i, o = t.overlayY;
        t.overlayX === "center" ? i = "center" : this._isRtl() ? i = t.overlayX === "start" ? "right" : "left" : i = t.overlayX === "start" ? "left" : "right";
        for (let n = 0; n < e.length; n++)
            e[n].style.transformOrigin = `${i} ${o}`;
    }
    _calculateBoundingBoxRect(t, e) {
        let i = this._viewportRect, o = this._isRtl(), n, r, a;
        if (e.overlayY === "top")
        ...
        let h = e.overlayX === "start" && !o || e.overlayX === "end" && o, d = e.overlayX === "end" && !o || e.overlayX === "start" && o, l, c, g;
        if (d)
    ...
    _setOverlayElementStyles(t, e) {
        let i = {}, o = this._hasExactPosition(), n = this._hasFlexibleDimensions, r = this._overlayRef.getConfig();
        if (o) {
            ...
            i.position = "static";
        let a = "", h = this._getOffset(e, "x"), d = this._getOffset(e, "y");
        h && (a += `translateX(${h}px) `), d && (a += `translateY(${d}px)`), i.transform = a.trim(), r.maxHeight && (o ? i.maxHeight = f(r.maxHeight) : n && (i.maxHeight = "")), r.maxWidth && (o ? i.maxWidth = f(r.maxWidth) : n && (i.maxWidth = "")), b(this._pane.style, i);
    }
    _getExactOverlayY(t, e, i) {
        let o = { top: "", bottom: "" }, n = this._getOverlayPoint(e, this._overlayRect, t);
        if (this._isPushed && (n = this._pushOverlayOnScreen(n, this._overlayRect, i)), t.overlayY === "bottom") {
    ...
    _getExactOverlayX(t, e, i) {
        let o = { left: "", right: "" }, n = this._getOverlayPoint(e, this._overlayRect, t);
        this._isPushed && (n = this._pushOverlayOnScreen(n, this._overlayRect, i));
        let r;
        if (this._isRtl() ? r = t.overlayX === "end" ? "left" : "right" : r = t.overlayX === "end" ? "right" : "left", r === "right") {
...
function ft(s) { return { top: Math.floor(s.top), right: Math.floor(s.right), bottom: Math.floor(s.bottom), left: Math.floor(s.left), width: Math.floor(s.width), height: Math.floor(s.height) }; }
function Wt(s, t) { return s === t ? !0 : s.isOriginClipped === t.isOriginClipped && s.isOriginOutsideView === t.isOriginOutsideView && s.isOverlayClipped === t.isOverlayClipped && s.isOverlayOutsideView === t.isOverlayOutsideView; }
var we = [{ originX: "start", originY: "bottom", overlayX: "start", overlayY: "top" }, { originX: "start", originY: "top", overlayX: "start", overlayY: "bottom" }, { originX: "end", originY: "bottom", overlayX: "end", overlayY: "top" }, { originX: "end", originY: "top", overlayX: "end", overlayY: "bottom" }], ke = [{ originX: "end", originY: "top", overlayX: "start", overlayY: "top" }, { originX: "end", originY: "bottom", overlayX: "start", overlayY: "bottom" }, { originX: "start", originY: "top", overlayX: "end", overlayY: "top" }, { originX: "start", originY: "bottom", overlayX: "end", overlayY: "bottom" }], gt = "cdk-global-overlay-wrapper";
function Ht(s) { return new K; }
var K = class {
    _overlayRef;
    _cssPosition = "static";
    _topOffset = "";
    ...
    apply() {
        if (!this._overlayRef || !this._overlayRef.hasAttached())
            return;
        let t = this._overlayRef.overlayElement.style, e = this._overlayRef.hostElement.style, i = this._overlayRef.getConfig(), { width: o, height: n, maxWidth: r, maxHeight: a } = i, h = (o === "100%" || o === "100vw") && (!r || r === "100%" || r === "100vw"), d = (n === "100%" || n === "100vh") && (!a || a === "100%" || a === "100vh"), l = this._xPosition, c = this._xOffset, g = this._overlayRef.getConfig().direction === "rtl", y = "", u = "", v = "";
        h ? v = "flex-start" : l === "center" ? (v = "center", g ? u = c : y = c) : g ? l === "left" || l === "end" ? (v = "flex-end", y = c) : (l === "right" || l === "start") && (v = "flex-start", u = c) : l === "left" || l === "start" ? (v = "flex-start", y = c) : (l === "right" || l === "end") && (v = "flex-end", u = c), t.position = this._cssPosition, t.marginLeft = h ? "0" : y, t.marginTop = d ? "0" : this._topOffset, t.marginBottom = this._bottomOffset, t.marginRight = h ? "0" : u, e.justifyContent = v, e.alignItems = d ? "flex-start" : this._alignItems;
    }
    dispose() {
        if (this._isDisposed || !this._overlayRef)
            return;
        let t = this._overlayRef.overlayElement.style, e = this._overlayRef.hostElement, i = e.style;
        e.classList.remove(gt), i.justifyContent = i.alignItems = t.marginTop = t.marginBottom = t.marginLeft = t.marginRight = t.position = "", this._overlayRef = null, this._isDisposed = !0;
    }
}, Ft = (() => {
    class s {
        _injector = p(R);
    ...
    return s;
})(), kt = new U("OVERLAY_DEFAULT_CONFIG");
...
var Nt = (() => {
    class s {
        scrollStrategies = p(Vt);
        _positionBuilder = p(Ft);
        _injector = p(R);
        constructor() { }
    ...
    return s;
})(), zt = [{ originX: "start", originY: "bottom", overlayX: "start", overlayY: "top" }, { originX: "start", originY: "top", overlayX: "start", overlayY: "bottom" }, { originX: "end", originY: "top", overlayX: "end", overlayY: "bottom" }, { originX: "end", originY: "bottom", overlayX: "end", overlayY: "top" }], Zt = new U("cdk-connected-overlay-scroll-strategy", { providedIn: "root", factory: () => { let s = p(R); return () => yt(s); } }), ut = (() => {
    class s {
        elementRef = p(B);
        constructor() { }
        static ɵfac = function (i) { return new (i || s); };
    ...
    return s;
})(), jt = new U("cdk-connected-overlay-default-config"), Oe = (() => {
    class s {
        _dir = p(V, { optional: !0 });
        _injector = p(R);
        _overlayRef;
        ...
        constructor() { let e = p(Et), i = p(Dt), o = p(jt, { optional: !0 }), n = p(kt, { optional: !0 }); this.usePopover = n?.usePopover === !1 ? null : "global", this._templatePortal = new it(e, i), this.scrollStrategy = this._scrollStrategyFactory(), o && this._assignConfig(o); }
        ...
        _createPositionStrategy() { let e = wt(this._injector, this._getOrigin()); return this._updatePositionStrategy(e), e; }
        _getOrigin() { return this.origin instanceof ut ? this.origin.elementRef : this.origin; }
        _getOriginElement() { return this.origin instanceof ut ? this.origin.elementRef.nativeElement : this.origin instanceof B ? this.origin.nativeElement : typeof Element < "u" && this.origin instanceof Element ? this.origin : null; }
