import { a as o, b as u, c as _ } from "@nf-internal/chunk-AHQ2JYHE";
...
var y = { capture: !0 }, I = ["focus", "mousedown", "mouseenter", "touchstart"], p = "mat-ripple-loader-uninitialized", l = "mat-ripple-loader-class-name", f = "mat-ripple-loader-centered", s = "mat-ripple-loader-disabled", M = (() => {
    class r {
        _document = n(v);
        ...
        _createRipple(e) {
            if (!this._document || this._hosts.has(e))
                return;
            e.querySelector(".mat-ripple")?.remove();
            let t = this._document.createElement("span");
            t.classList.add("mat-ripple", e.getAttribute(l)), e.append(t);
            let i = this._globalRippleOptions, g = this._animationsDisabled ? 0 : i?.animation?.enterDuration ?? o.enterDuration, h = this._animationsDisabled ? 0 : i?.animation?.exitDuration ?? o.exitDuration, a = { rippleDisabled: this._animationsDisabled || i?.disabled || e.hasAttribute(s), rippleConfig: { centered: e.hasAttribute(f), terminateOnPointerUp: i?.terminateOnPointerUp, animation: { enterDuration: g, exitDuration: h } } }, c = new u(a, this._ngZone, t, this._platform, this._injector), m = !a.rippleDisabled;
            m && c.setupTriggerEvents(e), this._hosts.set(e, { target: a, renderer: c, hasSetUpEvents: m }), e.removeAttribute(p);
        }
