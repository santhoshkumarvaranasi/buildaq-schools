import { a as R, b as T } from "@nf-internal/chunk-ULIK2NTW";
import { a as F } from "@nf-internal/chunk-5LCLK5PV";
import { i as A, m as V } from "@nf-internal/chunk-PINCHDN4";
import { a as P, b as L } from "@nf-internal/chunk-RN7SNFOD";
...
function ye(o, s) {
    if (o & 1 && n.ɵɵelement(0, "mat-pseudo-checkbox", 1), o & 2) {
        let e = n.ɵɵnextContext();
        n.ɵɵproperty("disabled", e.disabled)("state", e.selected ? "checked" : "unchecked");
    }
}
function be(o, s) {
    if (o & 1 && n.ɵɵelement(0, "mat-pseudo-checkbox", 3), o & 2) {
        let e = n.ɵɵnextContext();
        n.ɵɵproperty("disabled", e.disabled);
    }
}
function ve(o, s) {
    if (o & 1 && (n.ɵɵelementStart(0, "span", 4), n.ɵɵtext(1), n.ɵɵelementEnd()), o & 2) {
        let e = n.ɵɵnextContext();
...
function Se(o, s) {
    if (o & 1 && (i.ɵɵelementStart(0, "span", 4), i.ɵɵtext(1), i.ɵɵelementEnd()), o & 2) {
...
function Ie(o, s) {
    if (o & 1 && (i.ɵɵelementStart(0, "span", 11), i.ɵɵtext(1), i.ɵɵelementEnd()), o & 2) {
        let e = i.ɵɵnextContext(2);
        i.ɵɵadvance(), i.ɵɵtextInterpolate(e.triggerValue);
    }
}
function Ee(o, s) {
    if (o & 1 && (i.ɵɵelementStart(0, "span", 5), i.ɵɵconditionalCreate(1, De, 1, 0)(2, Ie, 2, 1, "span", 11), i.ɵɵelementEnd()), o & 2) {
        let e = i.ɵɵnextContext();
...
var lt = new O("mat-select-scroll-strategy", { providedIn: "root", factory: () => { let o = c(Ve); return () => Te(o); } }), st = new O("MAT_SELECT_CONFIG"), te = new O("MatSelectTrigger"), w = class {
    ...
    class o {
        ...
        _idGenerator = c(ze);
        _renderer = c(Le);
        _parentFormField = c(V, { optional: !0 });
        ...
        valueChange = new C;
        constructor() { let e = c(R), t = c(tt, { optional: !0 }), a = c(it, { optional: !0 }), r = c(new Be("tabindex"), { optional: !0 }); this.ngControl && (this.ngControl.valueAccessor = this), this._defaultOptions?.typeaheadDebounceInterval != null && (this.typeaheadDebounceInterval = this._defaultOptions.typeaheadDebounceInterval), this._errorStateTracker = new T(e, this.ngControl, a, t, this.stateChanges), this._scrollStrategy = this._scrollStrategyFactory(), this.tabIndex = r == null ? 0 : parseInt(r) || 0, this.id = this.id; }
        ...
        ngDoCheck() {
            let e = this._getTriggerAriaLabelledby(), t = this.ngControl;
        ...
        _applyModalPanelOwnership() {
            ...
            if (!e)
                return;
            let t = `${this.id}-panel`;
            this._trackedModal && q(this._trackedModal, "aria-owns", t), je(e, "aria-owns", t), this._trackedModal = e;
        }
        _clearFromModal() {
            if (!this._trackedModal)
                return;
            let e = `${this.id}-panel`;
            q(this._trackedModal, "aria-owns", e), this._trackedModal = null;
        }
        ...
        _exitAndDetach() {
            ...
            this._cleanupDetach?.(), this._cleanupDetach = () => { t(), clearTimeout(a), this._cleanupDetach = void 0; };
            let e = this.panel.nativeElement, t = this._renderer.listen(e, "animationend", r => { r.animationName === "_mat-select-exit" && (this._cleanupDetach?.(), this._detachOverlay()); }), a = setTimeout(() => { this._cleanupDetach?.(), this._detachOverlay(); }, 200);
        ...
        _handleClosedKeydown(e) {
            let t = e.keyCode, a = t === U || t === X || t === $e || t === Je, r = t === Q || t === Y, l = this._keyManager;
            if (!l.isTyping() && r && !k(e) || (this.multiple || e.altKey) && a)
        ...
        _handleOpenKeydown(e) {
            let t = this._keyManager, a = e.keyCode, r = a === U || a === X, l = t.isTyping();
            if (r && e.altKey)
        ...
        _setSelectionByValue(e) {
            if (this.options.forEach(t => t.setInactiveStyles()), this._selectionModel.clear(), this.multiple && e)
        ...
        _getPanelAriaLabelledby() {
            if (this.ariaLabel)
                return null;
            let e = this._parentFormField?.getLabelId() || null, t = e ? e + " " : "";
        ...
        _getTriggerAriaLabelledby() {
            ...
            return this.ariaLabelledby && (e += " " + this.ariaLabelledby), e || (e = this._valueId), e;
        }
        ...
        static ɵfac = function (t) { return new (t || o); };
        static ɵcmp = i.ɵɵdefineComponent({ type: o, selectors: [["mat-select"]], contentQueries: function (t, a, r) {
                if (t & 1 && (i.ɵɵcontentQuery(r, te, 5), i.ɵɵcontentQuery(r, _, 5), i.ɵɵcontentQuery(r, f, 5)), t & 2) {
                    let l;
                ...
                if (t & 1 && (i.ɵɵviewQuery(xe, 5), i.ɵɵviewQuery(Me, 5), i.ɵɵviewQuery(H, 5)), t & 2) {
                    let r;
...
`], encapsulation: 2, changeDetection: 0 });
    ...
    class o {
        ...
        static ɵinj = i.ɵɵdefineInjector({ imports: [Ae, v, Qe, Ke, F, v] });
    }
    return o;
})();
